...
final class CT_Forms_Renderer {
	...
	private static $current_field_warnings = array();
		 ...
		 * render_block method.
		 *
		 * @param mixed $attributes Parameter.
...
$form_uid = 'ct-form-' . $form_id . '-' . wp_generate_uuid4();
	...
	/**
	 * friendly_warning_message method.
	 *
	 * @param mixed $warnings Parameter.
	 * @return mixed
	 */
